...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var window: UIWindow?
    let networkController = TwitterService() // Global constant. Since this is a let, it is effectively a Singleton.
...
//        //myVC2.tabBarItem = UITabBarItem(title: "Pizza", image: secondImage, tag:2)
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "KP.TwitterClone" in the application's documents Application Support directory.
